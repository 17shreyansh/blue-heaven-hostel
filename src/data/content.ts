...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Our branches are spread across Knowledge Park and Alpha 1, within easy reach of institutions including Sharda University, Galgotias University, Gautam Buddha University and GL Bajaj Institute of Technology.",
  },
  {
    id: "f8",
...
export const GALLERY_IMAGES: GalleryImage[] = [
  { id: "g1", category: "Rooms", label: "Shared Room Interior", aspect: "aspect-[4/5]" },
  { id: "g2", category: "Common Areas", label: "Common Lounge", aspect: "aspect-square" },
  { id: "g3", category: "Study Spaces", label: "Study Desk Setup", aspect: "aspect-[3/4]" },
  { id: "g4", category: "Dining", label: "Dining Hall", aspect: "aspect-[4/3]" },
  { id: "g5", category: "Exteriors", label: "Building Exterior", aspect: "aspect-[4/5]" },
  { id: "g6", category: "Rooms", label: "Single Room Interior", aspect: "aspect-square" },
  { id: "g7", category: "Common Areas", label: "Reception Area", aspect: "aspect-[3/4]" },
  { id: "g8", category: "Study Spaces", label: "Reading Corner", aspect: "aspect-[4/5]" },
  { id: "g9", category: "Dining", label: "Mess Counter", aspect: "aspect-square" },
  { id: "g10", category: "Rooms", label: "Room Washroom", aspect: "aspect-[4/3]" },
  { id: "g11", category: "Exteriors", label: "Entrance Gate", aspect: "aspect-[3/4]" },
  { id: "g12", category: "Common Areas", label: "Terrace Common Area", aspect: "aspect-[4/5]" },
];
